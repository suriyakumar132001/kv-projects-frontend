...
import { ArrowLeft, Receipt, Save, RotateCcw, Loader2 } from "lucide-react";
...
export default function EditExpense() {
  ...
  const loadExpense = async () => {
    try {
      ...
      toast.error(error?.response?.data?.message || "Unable to load expense");
  ...
  useEffect(() => {
    ...
    const initialize = async () => {
      await Promise.all([loadProjects(), loadSites(), loadExpense()]);
    };
        ...
        >
          ...
          <div className="border-b border-gray-200 p-5 md:p-6">
            <div className="mb-5">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Update amount, category and date
              </p>
            </div>
          ...
          <div className="border-b border-gray-200 p-5 md:p-6">
            <div className="mb-5">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Update vendor and bill information
              </p>
            </div>
